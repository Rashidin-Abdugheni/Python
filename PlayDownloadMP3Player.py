...
top.title("MP3 Player Rashidin Abdugheni")
...
def selectPath():  # 随机播放
    folder_path = "C:/Users/Mr.R/Music/msc"
...
update_timeText()
# 选择文件
Button(top, text="Choose &Play", command=play, width=10, bg="sky blue").place(x=20, y=20)
Entry(top, text=path, width=30, state='readonly').place(x=120, y=20)


# 随机播放
Button(top, text="Random-Play", command=selectPath, width=7, bg="sky blue").place(x=20, y=225)
l2 = Label(top, text='', width=40, font=("Helvetica", 16))  # 音乐名
l2.place(x=0, y=100)
Button(top, text="Next", command=loops, width=5, bg="sky blue").place(x=100, y=225)
l3 = Label(top, text='', width=15)  # 音乐时长
l3.place(x=24, y=150)
# 暂停，继续播放，结束播放
Button(top, text="Pause", command=pause, width=7, bg="sky blue").place(x=170, y=225)
Button(top, text="Unpause", command=unpause, width=7, bg="sky blue").place(x=240, y=225)

# 音量
w1 = Scale(top, from_=0, to=100, orient="horizontal", length=75, variable=v, command=printScale, label="Voice")
